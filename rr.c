...
int main()
{
	...
	printf("enter the process number,arrival time,burst time,priority of the process");	
...
printf("Process name,Completion Time,TurnAround Time,Waiting Time");
	for(i=0;i<n;i++)
	{
		atat+=p[i].tt;
		avgwt+=p[i].wt;
